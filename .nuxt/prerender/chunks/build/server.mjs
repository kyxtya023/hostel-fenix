...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BXOpbFPW.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DE01fdg4.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "error-page" }, _attrs))} data-v-ba958501><div class="error-content" data-v-ba958501>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "ph:fire-fill",
        size: "56",
        class: "error-icon"
      }, null, _parent));
      _push(`<h1 class="error-code" data-v-ba958501>${ssrInterpolate(__props.error?.statusCode ?? 404)}</h1><p class="error-message" data-v-ba958501>${ssrInterpolate(__props.error?.statusCode === 404 ? "Страница не найдена" : "Что-то пошло не так")}</p><a href="/" class="error-btn" data-v-ba958501>Вернуться на главную</a></div></div>`);
    };
  }
});
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-ba958501"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export { __nuxt_component_0 as _, _export_sfc as a, useState as b, entry_default as default, useHead as u };
