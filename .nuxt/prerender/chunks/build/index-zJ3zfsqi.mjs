...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-d6214816><div class="container" data-v-d6214816><div class="gallery-header reveal" data-v-d6214816><div data-v-d6214816><p class="section-label" data-v-d6214816>\u0424\u043E\u0442\u043E\u0433\u0430\u043B\u0435\u0440\u0435\u044F</p><h2 class="section-title" data-v-d6214816> \u041A\u0430\u043A \u0443 \u043D\u0430\u0441<br data-v-d6214816><span class="text-accent" data-v-d6214816>\u0432\u044B\u0433\u043B\u044F\u0434\u0438\u0442</span></h2></div><p class="section-desc" data-v-d6214816> \u0421\u043C\u043E\u0442\u0440\u0438\u0442\u0435 \u0441\u0430\u043C\u0438 \u2014 \u0447\u0438\u0441\u0442\u044B\u0435 \u043D\u043E\u043C\u0435\u0440\u0430, \u0443\u044E\u0442\u043D\u044B\u0435 \u043E\u0431\u0449\u0438\u0435 \u0437\u043E\u043D\u044B \u0438 \u0432\u0441\u0451 \u043D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C\u043E\u0435 \u0434\u043B\u044F \u043A\u043E\u043C\u0444\u043E\u0440\u0442\u043D\u043E\u0433\u043E \u043F\u0440\u043E\u0436\u0438\u0432\u0430\u043D\u0438\u044F. </p></div><div class="masonry-grid" data-v-d6214816><!--[-->`);
      ssrRenderList(items, (item, i) => {
        _push(`<div class="${ssrRenderClass([`reveal-delay-${i % 5 + 1}`, "masonry-item reveal"])}" style="${ssrRenderStyle(item.style)}"${ssrRenderAttr("aria-label", `\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u0444\u043E\u0442\u043E: ${item.alt}`)} role="button" tabindex="0" data-v-d6214816><div class="masonry-img-wrap" data-v-d6214816><img${ssrRenderAttr("src", item.src)}${ssrRenderAttr("alt", item.alt)} class="masonry-img" data-v-d6214816><div class="masonry-overlay" aria-hidden="true" data-v-d6214816><div class="overlay-icon" data-v-d6214816>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "ph:magnifying-glass-plus-bold",
          size: "28"
        }, null, _parent));
        _push(`</div><span class="overlay-label" data-v-d6214816>${ssrInterpolate(item.alt)}</span></div></div></div>`);
      });
      _push(`<!--]--></div></div>`);
      if (lightboxIndex.value !== null) {
        _push(`<div class="lightbox" role="dialog" aria-modal="true"${ssrRenderAttr("aria-label", items[lightboxIndex.value].alt)} data-v-d6214816><div class="lightbox-inner" data-v-d6214816><button class="lightbox-close" aria-label="\u0417\u0430\u043A\u0440\u044B\u0442\u044C" data-v-d6214816>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "ph:x-bold",
          size: "22"
        }, null, _parent));
        _push(`</button><button class="lightbox-nav lightbox-prev" aria-label="\u041F\u0440\u0435\u0434\u044B\u0434\u0443\u0449\u0435\u0435 \u0444\u043E\u0442\u043E"${ssrIncludeBooleanAttr(lightboxIndex.value === 0) ? " disabled" : ""} data-v-d6214816>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "ph:arrow-left-bold",
          size: "22"
        }, null, _parent));
        _push(`</button><img${ssrRenderAttr("src", items[lightboxIndex.value].src)}${ssrRenderAttr("alt", items[lightboxIndex.value].alt)} class="lightbox-img" data-v-d6214816><button class="lightbox-nav lightbox-next" aria-label="\u0421\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0435 \u0444\u043E\u0442\u043E"${ssrIncludeBooleanAttr(lightboxIndex.value === items.length - 1) ? " disabled" : ""} data-v-d6214816>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "ph:arrow-right-bold",
          size: "22"
        }, null, _parent));
        _push(`</button><div class="lightbox-counter" data-v-d6214816>${ssrInterpolate(lightboxIndex.value + 1)} / ${ssrInterpolate(items.length)}</div><div class="lightbox-caption" data-v-d6214816>${ssrInterpolate(items[lightboxIndex.value].alt)}</div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section>`);
...
const GallerySection = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-d6214816"]]);
...
//# sourceMappingURL=index-zJ3zfsqi.mjs.map
