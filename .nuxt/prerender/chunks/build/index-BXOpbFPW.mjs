import { defineComponent, mergeProps, reactive, ref, computed, watch, unref, useSSRContext } from 'file://D:/%D0%A5%D0%BE%D1%81%D1%82%D0%B5%D0%BB%20%D0%A4%D0%B5%D0%BD%D0%B8%D0%BA%D1%81/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrIncludeBooleanAttr } from 'file://D:/%D0%A5%D0%BE%D1%81%D1%82%D0%B5%D0%BB%20%D0%A4%D0%B5%D0%BD%D0%B8%D0%BA%D1%81/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "rooms",
        class: "rooms section"
      }, _attrs))} data-v-911699c7><div class="container" data-v-911699c7><div class="rooms-header reveal" data-v-911699c7><div data-v-911699c7><p class="section-label" data-v-911699c7>\u0420\u0430\u0437\u043C\u0435\u0449\u0435\u043D\u0438\u0435</p><h2 class="section-title" data-v-911699c7> \u0420\u0430\u0437\u043C\u0435\u0449\u0435\u043D\u0438\u0435 \u043F\u043E<br data-v-911699c7><span class="text-accent" data-v-911699c7>\u0447\u0438\u0441\u043B\u0443 \u043C\u0435\u0441\u0442</span></h2></div><p class="section-desc" data-v-911699c7> \u0421\u043E\u0432\u0440\u0435\u043C\u0435\u043D\u043D\u044B\u0435 \u043D\u043E\u043C\u0435\u0440\u0430 \u043D\u0430 \u043B\u044E\u0431\u043E\u0439 \u0432\u043A\u0443\u0441. \u0412\u044B\u0431\u0438\u0440\u0430\u0439\u0442\u0435 \u043F\u043E\u0434\u0445\u043E\u0434\u044F\u0449\u0438\u0439 \u0432\u0430\u0440\u0438\u0430\u043D\u0442 \u2014 \u043E\u0442 \u0443\u044E\u0442\u043D\u043E\u0433\u043E \u043C\u0435\u0441\u0442\u0430 \u0432 \u043E\u0431\u0449\u0435\u043C \u043D\u043E\u043C\u0435\u0440\u0435 \u0434\u043E \u043A\u043E\u043C\u0444\u043E\u0440\u0442\u043D\u043E\u0433\u043E \u0440\u0430\u0437\u043C\u0435\u0449\u0435\u043D\u0438\u044F \u0441 \u0434\u0440\u0443\u0437\u044C\u044F\u043C\u0438. </p></div><div class="rooms-grid" data-v-911699c7><!--[-->`);
      ssrRenderList(rooms, (room, i) => {
        _push(`<div class="${ssrRenderClass([[`reveal-delay-${i + 1}`, { featured: room.featured }], "room-card glass-card reveal"])}" data-v-911699c7><div class="room-header-block" data-v-911699c7><div class="bed-badge" data-v-911699c7>${ssrInterpolate(room.places)}</div>`);
        if (room.featured) {
          _push(`<span class="room-badge" data-v-911699c7>${ssrInterpolate(room.badge)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="room-title-block" data-v-911699c7><h3 class="room-title" data-v-911699c7>${ssrInterpolate(room.title)}</h3><p class="room-desc" data-v-911699c7>${ssrInterpolate(room.desc)}</p></div><ul class="room-features" data-v-911699c7><!--[-->`);
        ssrRenderList(room.features, (feature) => {
          _push(`<li data-v-911699c7>`);
          _push(ssrRenderComponent(_component_Icon, {
        ...
        _push(`<!--]--></ul><div class="prices-container" data-v-911699c7><div class="price-block" data-v-911699c7><div class="price-label" data-v-911699c7>\u0414\u043E 7 \u0434\u043D\u0435\u0439</div><div class="price-value" data-v-911699c7>${ssrInterpolate(room.prices.shortTerm)}</div><div class="price-unit" data-v-911699c7>/ \u043D\u043E\u0447\u044C</div></div><div class="price-divider" data-v-911699c7></div><div class="price-block" data-v-911699c7><div class="price-label" data-v-911699c7>\u041E\u0442 7 \u0434\u043D\u0435\u0439</div><div class="price-value" data-v-911699c7>${ssrInterpolate(room.prices.mediumTerm)}</div><div class="price-unit" data-v-911699c7>/ \u043D\u043E\u0447\u044C</div></div><div class="price-divider" data-v-911699c7></div><div class="price-block" data-v-911699c7><div class="price-label" data-v-911699c7>\u041C\u0435\u0441\u044F\u0446</div><div class="price-value" data-v-911699c7>${ssrInterpolate(room.prices.longTerm)}</div><div class="price-unit" data-v-911699c7>/ \u043C\u0435\u0441\u044F\u0446</div></div></div><a href="https://ostrovok.ru/hotel/russia/moscow/mid13859187/feniks_hostel_5" target="_blank" class="${ssrRenderClass([{ "cta-featured": room.featured }, "room-cta"])}" data-v-911699c7> \u0417\u0430\u0431\u0440\u043E\u043D\u0438\u0440\u043E\u0432\u0430\u0442\u044C `);
        _push(ssrRenderComponent(_component_Icon, {
          name: "ph:arrow-right",
          size: "16"
        }, null, _parent));
...
const RoomsSection = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-911699c7"]]);
...
//# sourceMappingURL=index-BXOpbFPW.mjs.map
